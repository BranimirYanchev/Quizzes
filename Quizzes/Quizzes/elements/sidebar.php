<script src="https://code.jquery.com/jquery-3.7.1.slim.min.js" integrity="sha256-kmHvs0B+OpCW5GVHUNjv9rOmY0IvSIRcf7zGUDTDQM8=" crossorigin="anonymous"></script>
    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    ...
                    <div class="menu-item">
                        ...
                        <a href="#" class="menu-link px-3 py-3" data-kt-element="project">
                            ...
                            <span class="d-flex flex-column align-items-start">
                                ...
                                <span class="fs-7 fw-bold text-gray-700 lh-sm" data-kt-element="desc">CSS &amp;
                                    JS Framework</span>
                            </span>
                            <!--end::Info-->
                        </a>
        ...
        <div class="app-sidebar-navs flex-column-fluid mx-2 py-6" id="kt_app_sidebar_navs">
            <div id="kt_app_sidebar_navs_wrappers" class="hover-scroll-y my-2" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_header, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_navs" data-kt-scroll-offset="5px" style="height: 623px;">
                <!--begin::Separator-->
                ...
                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="menu menu-column menu-rounded menu-sub-indention menu-active-bg">
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion active">
                        <!--begin::Menu Item-->
                        <div class="menu-item">
                            <!--begin::Menu link-->
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin::Menu link-->
                            <a href="apps/products.php" class="menu-link">
                                <!--begin::Icon-->
                                <span class="menu-icon">
        ...
        <div class="app-sidebar-footer d-flex flex-stack px-11 pb-10" id="kt_app_sidebar_footer">
            ...
            <div>
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
                ...
                </div><div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" style="">
                    <!--begin::Menu item-->
                    ...
                    <div class="separator m-t-40"></div>
                    <!--end::Menu separator-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="account/settings.php" class="menu-link px-5">My Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="apps/ecommerce/catalog/products.php" class="menu-link px-5">
                            <span class="menu-text">My Quizzes</span>
                    ...
                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                        ...
                        <!--begin::Menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px show" data-kt-menu="true" data-kt-element="theme-mode-menu">
                            <!--begin::Menu item-->
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="authentication/sign-in.php" class="menu-link px-5">Sign
                            Out</a>
                    </div>
                    <!--end::Menu item-->
                </div>
            ...
            <!--end::User menu-->
            <!--begin::Logout-->
            <a href="authentication/sign-in.php" class="btn btn-sm btn-outline btn-flex btn-custom px-3">
