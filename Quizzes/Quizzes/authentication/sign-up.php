...
<base href="../" />
		...
		<link rel="canonical" href="http://authentication/layouts/corporate/sign-up.php" />
		<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
		<link rel="shortcut icon" href="assets/media/logos/favicon.ico" />
		<link rel="shortcut icon" href="src/css/toastr.css/favicon.ico" />
...
>>>>>>> Stashed changes:Quizzes/authentication/sign-up.php
								...
								<input class="form-control form-control-lg form-control-solid" type="text" placeholder="Username" name="username" autocomplete="off" data-kt-translate="sign-up-input-username" />
								</div>
								<!--end::Input group-->
								...
								<!--begin::Input group-->
								<div class="fv-row mb-10">
									<input class="form-control form-control-lg form-control-solid" type="password" placeholder="Confirm Password" name="confirmPassword" autocomplete="off" data-kt-translate="sign-up-input-confirm-password" />
								</div>
								<!--end::Input group-->
								<!--begin::Actions-->
