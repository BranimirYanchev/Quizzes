...
<html lang="en">
	...
	<head>
		...
		<link rel="canonical" href="http://account/settings.php" />
						...
						<div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
							...
							<div class="page-title gap-4 me-3 mb-5 mb-lg-0" data-kt-swapper="1" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Pages</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item">
										<i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
								...
								<!--end::Breadcrumb-->
								<!--begin::Title-->
								<h1 class="text-gray-900 fw-bolder m-0">Account Settings</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
							<!--begin::Action-->
...
<<<<<<< Updated upstream:Quizzes/Quizzes/account/settings.php
<<<<<<<< Updated upstream:Quizzes/Quizzes/account/settings.php
=======
>>>>>>> Stashed changes:Quizzes/account/settings.php
					<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
						<!--begin::Navs-->
						<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
							<!--begin::Nav item-->
							<li class="nav-item mt-2">
								<a class="nav-link text-active-primary ms-0 me-5 me-lg-8 pt-2 pb-3 pt-lg-4 pb-lg-5" href="index.php">Overview</a>
							</li>
							<!--end::Nav item-->
							<!--begin::Nav item-->
							<li class="nav-item mt-2">
								<a class="nav-link text-active-primary ms-0 me-5 me-lg-8 pt-2 pb-3 pt-lg-4 pb-lg-5 active" href="account/settings.php">Settings</a>
							</li>
							<!--end::Nav item-->
						</ul>
						<!--begin::Navs-->
...
========
					...
					<div id="kt_app_toolbar" class="app-toolbar">
						...
						<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
							...
							<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
								<!--begin::Nav item-->
								<li class="nav-item mt-2">
									<a class="nav-link text-active-primary ms-0 me-5 me-lg-8 pt-2 pb-3 pt-lg-4 pb-lg-5" href="index.html">Overview</a>
								</li>
								<!--end::Nav item-->
								<!--begin::Nav item-->
								<li class="nav-item mt-2">
									<a class="nav-link text-active-primary ms-0 me-5 me-lg-8 pt-2 pb-3 pt-lg-4 pb-lg-5 active" href="account/settings.html">Settings</a>
								</li>
								<!--end::Nav item-->
								<!--begin::Nav item-->
								<li class="nav-item mt-2">
					...
					<!--end::Sidebar-->
>>>>>>>> Stashed changes:Quizzes/account/settings.html
=======
>>>>>>> Stashed changes:Quizzes/account/settings.php
					<!--begin::Main-->
