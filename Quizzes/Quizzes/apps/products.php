...
<base href="../" />
		...
		<link rel="canonical" href="http://apps/ecommerce/catalog/products.php" />
						...
						<div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
							...
							<div class="page-title gap-4 me-3 mb-5 mb-lg-0" data-kt-swapper="1" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
								...
								<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Apps</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item">
										<i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-gray-600 fw-bold lh-1">eCommerce</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item">
										<i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-gray-600 fw-bold lh-1">Catalog</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
								<!--begin::Title-->
								<h1 class="text-gray-900 fw-bolder m-0">Products</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
							<!--begin::Action-->
...
<<<<<<< Updated upstream:Quizzes/Quizzes/apps/products.php
=======
					<!--begin::Sidebar-->
						...
						<div class="app-sidebar-header d-none d-lg-flex px-6 pt-8 pb-4" id="kt_app_sidebar_header">
							...
							<button type="button" data-kt-element="selected" class="btn btn-outline btn-custom btn-flex w-100" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, -1px">
								...
								<span class="d-flex flex-column me-n4">
									<i class="ki-outline ki-up fs-2 text-gray-700"></i>
									<i class="ki-outline ki-down fs-2 text-gray-700"></i>
								</span>
								<!--end::Arrows-->
							</button>
							<!--end::Toggle-->
								...
								<div class="hover-scroll-y h-250px my-3 pe-5 me-n1">
									...
									<div class="menu-item">
										...
										<a href="#" class="menu-link px-3 py-3" data-kt-element="project">
											...
											<!--begin::Info-->
											<span class="d-flex flex-column align-items-start">
												<span class="fs-5 fw-bold text-white text-uppercase" data-kt-element="title">Slack</span>
												<span class="fs-7 fw-bold text-gray-700 lh-sm" data-kt-element="desc">Messanger</span>
											</span>
											<!--end::Info-->
										</a>
									</div>
									...
									<div class="menu-item">
										...
										<a href="#" class="menu-link px-3 py-3" data-kt-element="project">
											...
											<!--begin::Info-->
											<span class="d-flex flex-column align-items-start">
												<span class="fs-5 fw-bold text-white text-uppercase" data-kt-element="title">Dribbble</span>
												<span class="fs-7 fw-bold text-gray-700 lh-sm" data-kt-element="desc">Community</span>
											</span>
											<!--end::Info-->
										</a>
									</div>
									...
									<div class="menu-item">
										...
										<a href="#" class="menu-link px-3 py-3" data-kt-element="project">
											...
											<!--begin::Info-->
											<span class="d-flex flex-column align-items-start">
												<span class="fs-5 fw-bold text-white text-uppercase" data-kt-element="title">Bootstrap</span>
												<span class="fs-7 fw-bold text-gray-700 lh-sm" data-kt-element="desc">CSS & JS Framework</span>
											</span>
											<!--end::Info-->
										</a>
									</div>
									...
									<div class="menu-item">
										...
										<a href="#" class="menu-link px-3 py-3" data-kt-element="project">
											...
											<!--begin::Info-->
											<span class="d-flex flex-column align-items-start">
												<span class="fs-5 fw-bold text-white text-uppercase" data-kt-element="title">Spotify</span>
												<span class="fs-7 fw-bold text-gray-700 lh-sm" data-kt-element="desc">Podcasts</span>
											</span>
											<!--end::Info-->
										</a>
									</div>
									...
									<div class="menu-item">
										...
										<a href="#" class="menu-link px-3 py-3" data-kt-element="project">
											...
											<!--begin::Info-->
											<span class="d-flex flex-column align-items-start">
												<span class="fs-5 fw-bold text-white text-uppercase" data-kt-element="title">Beats</span>
												<span class="fs-7 fw-bold text-gray-700 lh-sm" data-kt-element="desc">Electronics</span>
											</span>
											<!--end::Info-->
										</a>
									</div>
						...
						<div class="app-sidebar-navs flex-column-fluid mx-2 py-6" id="kt_app_sidebar_navs">
							<div id="kt_app_sidebar_navs_wrappers" class="hover-scroll-y my-2" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_header, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_navs" data-kt-scroll-offset="5px">
								...
								<div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="menu menu-column menu-rounded menu-sub-indention menu-active-bg">
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="apps/ecommerce/catalog/products.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
									...
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link" href="https://preview.keenthemes.com/metronic8/demo27/layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
								...
								<div class="menu menu-rounded menu-column">
									<!--begin::Heading-->
									<div class="menu-item">
										<div class="menu-content menu-heading">Projects</div>
									</div>
									<!--end::Heading-->
									<!--begin::Menu Item-->
									<div class="menu-item">
					...
					<!--end::Sidebar-->
>>>>>>> Stashed changes:Quizzes/apps/ecommerce/catalog/products.html
					<!--begin::Main-->
...
<<<<<<< Updated upstream:Quizzes/Quizzes/apps/products.php
												<!--begin::Add Quiz-->
												<a href="apps/add-product.php" class="btn btn-primary">Add Quiz</a>
												<!--end::Add Quiz-->
=======
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<td>
															<div class="d-flex align-items-center">
																<!--begin::Thumbnail-->
																<a href="apps/ecommerce/catalog/edit-product.php" class="symbol symbol-50px">
																	<span class="symbol-label" style="background-image:url(assets/media//stock/ecommerce/1.png);"></span>
																</a>
																<!--end::Thumbnail-->
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="apps/ecommerce/catalog/edit-product.php" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">Product 1</a>
																	<!--end::Title-->
																</div>
															</div>
														</td>
														<td class="text-end pe-0">
															<span class="fw-bold">03721005</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01563002</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01662006</span>
														</td>
														<td class="text-end pe-0" data-order="13">
															<span class="fw-bold ms-3">13</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04444001</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01608003</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02280004</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04764006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01290004</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">03910004</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02217005</span>
														</td>
														<td class="text-end pe-0" data-order="32">
															<span class="fw-bold ms-3">32</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04926002</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04888005</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04926007</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04986008</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02334009</span>
														</td>
														<td class="text-end pe-0" data-order="30">
															<span class="fw-bold ms-3">30</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02487004</span>
														</td>
														<td class="text-end pe-0" data-order="30">
															<span class="fw-bold ms-3">30</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">03533003</span>
														</td>
														<td class="text-end pe-0" data-order="34">
															<span class="fw-bold ms-3">34</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01560008</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01832006</span>
														</td>
														<td class="text-end pe-0" data-order="32">
															<span class="fw-bold ms-3">32</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04803007</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02458006</span>
														</td>
														<td class="text-end pe-0" data-order="8">
															<span class="badge badge-light-warning">Low stock</span>
															<span class="fw-bold text-warning ms-3">8</span>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04560005</span>
														</td>
														<td class="text-end pe-0" data-order="34">
															<span class="fw-bold ms-3">34</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04391006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04668005</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02404005</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02387006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01436006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01141006</span>
														</td>
														<td class="text-end pe-0" data-order="17">
															<span class="fw-bold ms-3">17</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">03618007</span>
														</td>
														<td class="text-end pe-0" data-order="18">
															<span class="fw-bold ms-3">18</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01518006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02462004</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04605006</span>
														</td>
														<td class="text-end pe-0" data-order="32">
															<span class="fw-bold ms-3">32</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02595008</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01467006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04621007</span>
														</td>
														<td class="text-end pe-0" data-order="31">
															<span class="fw-bold ms-3">31</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01208004</span>
														</td>
														<td class="text-end pe-0" data-order="6">
															<span class="badge badge-light-warning">Low stock</span>
															<span class="fw-bold text-warning ms-3">6</span>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04205006</span>
														</td>
														<td class="text-end pe-0" data-order="18">
															<span class="fw-bold ms-3">18</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02458002</span>
														</td>
														<td class="text-end pe-0" data-order="49">
															<span class="fw-bold ms-3">49</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01971007</span>
														</td>
														<td class="text-end pe-0" data-order="34">
															<span class="fw-bold ms-3">34</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04920009</span>
														</td>
														<td class="text-end pe-0" data-order="41">
															<span class="fw-bold ms-3">41</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">03603003</span>
														</td>
														<td class="text-end pe-0" data-order="21">
															<span class="fw-bold ms-3">21</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02151008</span>
														</td>
														<td class="text-end pe-0" data-order="41">
															<span class="fw-bold ms-3">41</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02426004</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">03116009</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">02394002</span>
														</td>
														<td class="text-end pe-0" data-order="49">
															<span class="fw-bold ms-3">49</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01177001</span>
														</td>
														<td class="text-end pe-0" data-order="39">
															<span class="fw-bold ms-3">39</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">04229006</span>
														</td>
													...
													<tr>
														...
														<td class="text-end pe-0">
															<span class="fw-bold">01635001</span>
														</td>
														<td class="text-end pe-0" data-order="24">
															<span class="fw-bold ms-3">24</span>
														</td>
								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="apps/projects/project.php" class="w-30px me-3" src="assets/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="apps/projects/project.php" class="w-30px me-3" src="assets/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="apps/ecommerce/sales/details.php" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
