...
<base href="../" />
		...
		<link rel="canonical" href="http://apps/ecommerce/catalog/edit-product.php" />
					...
					<div class="app-container container-fluid d-flex flex-stack" id="kt_app_header_container">
						...
						<div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
							...
							<div class="page-title gap-4 me-3 mb-5 mb-lg-0" data-kt-swapper="1" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
								...
								<!--end::Breadcrumb-->
								<!--begin::Title-->
								<h1 class="text-gray-900 fw-bolder m-0">Edit Quiz</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
						</div>
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-fluid">
									<!--begin::Form-->
									<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="apps/ecommerce/catalog/products.php">
										<!--begin::Aside column-->
										<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body text-center pt-0">
													...
													<!--end::Image input-->
													<!--begin::Description-->
													<div class="text-muted fs-7">Set the quiz thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
													<!--end::Description-->
												</div>
												<!--end::Card body-->
											</div>
										...
										<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
													...
													<div class="d-flex flex-column gap-7 gap-lg-10">
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row">
																	<!--begin::Label-->
																	<label class="required form-label">Quiz Name</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="product_name" class="form-control mb-2" placeholder="Quiz name" value="Sample quiz" />
																	<!--end::Input-->
																	<!--begin::Description-->
																	<div class="text-muted fs-7">A quiz name is required and recommended to be unique.</div>
																	<!--end::Description-->
																</div>
																<!--end::Input group-->
																<!--begin::Input group-->
																<div>
																	...
																	<!--end::Editor-->
																	<!--begin::Description-->
																	<div class="text-muted fs-7">Set a description to the quiz for better visibility.</div>
																	<!--end::Description-->
																</div>
																<!--end::Input group-->
															</div>
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<!--end::Input group-->
																<!--begin::Description-->
																<div class="text-muted fs-7">Set the quiz files.</div>
																<!--end::Description-->
															</div>
															<!--end::Card header-->
														</div>
																...
																<table class="table table-row-dashed fs-6 gy-5 my-0" id="kt_ecommerce_add_product_reviews">
																	...
																	<tbody>
																		<tr>
																			...
																			<td>
																				<a href="apps/inbox/reply.php" class="d-flex text-gray-900 text-gray-800 text-hover-primary">
																					<!--begin::Avatar-->
											...
											<div class="d-flex justify-content-end">
												<!--begin::Button-->
												<a href="apps/ecommerce/catalog/products.php" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
												<!--end::Button-->
												<!--begin::Button-->
