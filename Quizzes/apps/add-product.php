...
<base href="../" />
		...
		<link rel="canonical" href="http://apps/ecommerce/catalog/add-product.php" />
	...
	<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
					...
					<div class="app-container container-fluid d-flex flex-stack" id="kt_app_header_container">
						...
						<div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
							...
							<div class="page-title gap-4 me-3 mb-5 mb-lg-0" data-kt-swapper="1" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
								...
								<!--end::Breadcrumb-->
								<!--begin::Title-->
								<h1 class="text-gray-900 fw-bolder m-0">Product Form</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
						</div>
                ...
                <!--end:Sidebar-->
				<!--begin::Wrapper-->
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper"></div>
					<!--begin::Main-->
