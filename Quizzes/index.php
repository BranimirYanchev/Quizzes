    ...
    >
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <div id="kt_app_header" class="app-header m-0" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}" data-kt-sticky-name="app-header-sticky" data-kt-sticky-offset="{default: false, lg: '300px'}">
                ...
                <!--end::Header-->
                <!--begin::Wrapper-->
                <div class="app-wrapper flex-column flex-row-fluid m-0" id="kt_app_wrapper">
                    <!--begin::Toolbar-->
                                                    ...
                                                    <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px;">
                                                        ...
                                                        <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                                            ...
                                                            <div class="d-flex flex-stack">
                                                                <!--begin::Name-->
                                                                <span class="text-gray-500 fw-bold">From: <a href="apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">Jason Bourne</a></span>
                                                                <!--end::Name-->
                                                            </div>
                                                            <!--end::Customer-->
                                                        </div>
                                            ...
                                            <div class="card card-flush h-xl-100">
                                                ...
                                                <div class="card-header pt-7">
                                                    ...
                                                    <div class="card-toolbar">
                                                        <a href="apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">Add Quiz</a>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Card header-->
        ...
        >
            <div class="card shadow-none border-0 rounded-0">
                ...
                <div class="card-footer py-5 text-center" id="kt_activities_footer">
                    <a href="pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View All Activities <i class="ki-outline ki-arrow-right fs-3 text-primary"></i></a>
                </div>
                <!--end::Footer-->
            </div>
        </div>
